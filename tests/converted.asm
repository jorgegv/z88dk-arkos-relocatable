defc PLY_AKG_FULL_INIT_CODE = 0x1
defc PLY_AKG_OFFSET1B = 0x1
defc PLY_AKG_USE_HOOKS = 0x1
defc PLY_AKG_STOP_SOUNDS = 0x1
defc PLY_AKG_BITFORSOUND = 0x2
defc PLY_AKG_OFFSET2B = 0x2
defc PLY_AKG_SOUNDEFFECTDATA_OFFSETINVERTEDVOLUME = 0x2

PLY_AKG_START:
PLY_AKG_OPCODE_ADD_HL_BC_MSB:
	jp PLY_AKG_INIT
defc PLY_AKG_SOUNDEFFECTDATA_OFFSETSPEED = 0x1
defc PLY_AKG_BITFORNOISE = 0x2
PLY_AKG_SOUNDEFFECTDATA_OFFSETCURRENTSTEP:
	jp PLY_AKG_PLAY
defc PLY_AKG_CHANNEL_SOUNDEFFECTDATASIZE = 0x2
...
PLY_AKG_PTSOUNDEFFECTTABLE:
	...
	ld b,0
defc PLY_AKG_OPCODE_INC_HL = 0x1
	sla c
	sla c
	sla c
	add hl,bc
...
PLY_AKG_PSES_NOTREACHED:
	inc (ix+3)
	ret 
defc PLY_AKG_OPCODE_ADD_A_IMMEDIATE = 0x2
...
defc PLY_AKG_CHANNEL1_INVERTEDVOLUMEINTEGER = 0x2
...
PLY_AKG_CHANNEL1_PITCHTRACKDECIMALCOUNTER:
	ld a,0
defc PLY_AKG_CHANNEL1_PITCHTRACKDECIMALVALUE = 0x1
...
defc PLY_AKG_CHANNEL2_INVERTEDVOLUMEINTEGER = 0x2
...
PLY_AKG_CHANNEL2_PITCHTRACKDECIMALCOUNTER:
	ld a,0
defc PLY_AKG_CHANNEL2_PITCHTRACKDECIMALVALUE = 0x1
...
defc PLY_AKG_CHANNEL3_INVERTEDVOLUMEINTEGER = 0x2
...
PLY_AKG_CHANNEL3_PITCHTRACKDECIMALCOUNTER:
	ld a,0
defc PLY_AKG_CHANNEL3_PITCHTRACKDECIMALVALUE = 0x1
...
PLY_AKG_PSGREG45_INSTR:
	...
	out (c),h
	ld b,e
defc PLY_AKG_PSGREG6 = 0x1
defc PLY_AKG_PSGREG8 = 0x2
PLY_AKG_PSGREG6_8_INSTR:
	...
	out (c),h
	ld b,e
defc PLY_AKG_PSGREG9 = 0x1
defc PLY_AKG_PSGREG10 = 0x2
