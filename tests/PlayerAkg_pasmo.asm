PLY_AKG_FULL_INIT_CODE equ $+1
PLY_AKG_OFFSET1B equ $+1
PLY_AKG_USE_HOOKS equ $+1
PLY_AKG_STOP_SOUNDS equ $+1
PLY_AKG_BITFORSOUND equ $+2
PLY_AKG_OFFSET2B equ $+2
PLY_AKG_SOUNDEFFECTDATA_OFFSETINVERTEDVOLUME equ $+2
PLY_AKG_START
PLY_AKG_OPCODE_ADD_HL_BC_MSB jp PLY_AKG_INIT
PLY_AKG_SOUNDEFFECTDATA_OFFSETSPEED equ $+1
PLY_AKG_BITFORNOISE equ $+2
PLY_AKG_SOUNDEFFECTDATA_OFFSETCURRENTSTEP jp PLY_AKG_PLAY
PLY_AKG_CHANNEL_SOUNDEFFECTDATASIZE equ $+2
...
PLY_AKG_PSES_NOTREACHED inc (ix+3)
    ret 
PLY_AKG_OPCODE_ADD_A_IMMEDIATE equ $+2
...
PLY_AKG_PSES_SOFTWAREORSOFTWAREANDHARDWARE rra 
    ...
    rl b
    call PLY_AKG_PSES_READNOISEIFNEEDEDANDOPENORCLOSENOISECHANNEL
PLY_AKG_OPCODE_SUB_IMMEDIATE res 2,c
...
PLY_AKG_PSES_SHARED_READRETRIGHARDWAREENVPERIODNOISE rra 
    ...
    ld d,a
    ld a,255
PLY_AKG_OPCODE_SBC_HL_BC_MSB ld (PLY_AKG_PSGREG13_OLDVALUE+1),a
    ld a,d
